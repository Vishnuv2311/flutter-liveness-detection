...
import 'package:flutter_liveness_detection_plugin/src/core/constants/liveness_detection_step_constant.dart';
...
class _LivenessDetectionScreenState extends State<LivenessDetectionView> {
  ...
  Future<void> _processImage(InputImage inputImage) async {
    ...
    if (inputImage.metadata?.size != null &&
      ...
      if (faces.isEmpty) {
        if (!_isProcessingStep) _resetSteps();
  ...
  Future<void> _handlingBlinkStep({
    ...
    final blinkThreshold =
        FlutterLivenessDetectionPlugin.instance.thresholdConfig
